...
# 1. Decode base64 URL-safe representation
...
print("Decoded URL length:", len(decoded_str))
print("Decoded URL contains 'BhMo%2BXGW':", "BhMo%2BXGW" in decoded_str)
print("Decoded URL contains 'BhMo%2BgW':", "BhMo%2BgW" in decoded_str)

# Let's perform replacements in the decoded URL string
